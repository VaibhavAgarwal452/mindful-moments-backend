...
export const CATEGORIES = {
    ...
    friends: ["friendship", "soul", "humor", "self", "joy"],
    work: ["dreams", "passion", "humanity", "leadership"],
    health: ["heart", "life", "living", "strength"],
    relationship: ["love", "hope", "humor", "relationships"]
}
...
const registerUser = asyncHandler(async (req, res) => {
    const { name, email, password, gender, areasOfImprovement, reasonForImprovement, feelingLately, expoPushToken } = req.body
...
const checkIfUserEmailExists = asyncHandler(async (req, res) => {
    ...
    if (currentEmail) {
        return res.status(200).json(new ApiResponse(200, true, "User Does exist"))
    }
...
const sendNotification = asyncHandler(async (req, res) => {
    ...
    sendNotificationToAllUsers(bodyText)
